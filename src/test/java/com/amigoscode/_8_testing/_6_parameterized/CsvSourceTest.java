...
class CsvSourceTest {
    ...
    @ParameterizedTest
    @CsvSource({"1, 1, 2", "2, 3, 5", "10, -5, 5", "0, 0, 0", "-3, -7, -10"})
    void testNumbersAddReturnExceptedSum(int a, int b, int expectedSum) {
        assertThat(Integer.sum(a, b)).isEqualTo(expectedSum);
    }
    ...
    void testFromCSVFile(String email, boolean expected) {
    ...
    void shouldCheckStringLength(String input, int expectedLength) {
