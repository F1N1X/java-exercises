...
public class Pair<K, V> {
    ...
    public static void main(String[] args) {
        ...
        Pair<String, Integer> peter = new Pair<>("Peter", 45);
        System.out.println(peter.swap());
        Pair<String, Integer> peterCopy = new Pair<>("Peter", 45);
        System.out.println(peter.equals(peterCopy));
    }
}
