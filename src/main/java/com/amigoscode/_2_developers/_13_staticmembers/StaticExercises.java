...
public class StaticExercises {
    ...
    public String getInfo() {
        return "Instance: " + this.instanceName + ", Total instances: " + counter;
    }
    ...
    public static StaticExercises createDefault(String descriptionName) {
        return new StaticExercises(descriptionName);
    }
