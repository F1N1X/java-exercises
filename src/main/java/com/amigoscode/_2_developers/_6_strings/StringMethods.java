...
public class StringMethods {
    ...
    public static String compareEquality(String a, String b) {
        ...
        String resultEquals = "equals: ";
        String resultEqualsIgnoreCase = "equalsIgnoreCase: ";
        boolean isEqual = a.equals(b);
        boolean isEqualIgnoreCase = a.equalsIgnoreCase(b);

        return resultEquals.concat(String.valueOf(isEqual)).concat(", ")
                .concat(resultEqualsIgnoreCase.concat(String.valueOf(isEqualIgnoreCase)));
    }
    ...
    public static String compareLexicographic(String a, String b) {
        ...
        return compared == 0 ? "equal" : compared < 0 ? "before" : "after";
    }
    ...
    public static String searchString(String text, String keyword) {
        ...
        boolean containsKeyword = text.contains(keyword);
        int index = text.indexOf(keyword);
        return "contains: " + containsKeyword + ", indexOf: " + index;
    }
    ...
    public static String splitDemo(String text, String delimiter) {
        ...
        for (int i = 0; i < splitText.length; i++) {
            builder.append("[").append(i).append("] ").append(splitText[i]).append("\n");
        }
    ...
    public static String checkStartEnd(String filename, String prefix, String extension) {
        ...
        return "startsWith " + prefix + ": " + filename.startsWith(prefix) + ", endsWith " + extension + ": " + filename.endsWith(extension);
    }
    ...
    public static String formatReceipt(String item, int quantity, double price) {
        ...
        return String.format("%-15s %-5d $%.2f", item, quantity, price);
    }
