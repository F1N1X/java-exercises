...
public class FunctionalInterfaceBasics {
    ...
    public static void main(String[] args) {
        ...
        Greeting greeting3 = name -> System.out.printf("Hello %s \n", name);
        greeting3.greet("Friend");
