...
public class CombinatorPattern {
    ...
    public interface CustomerValidator extends Function<Customer, ValidationResult> {
        ...
        default CustomerValidator and(CustomerValidator next) {
            return customer -> {
                ValidationResult result = this.apply(customer);
                return result != ValidationResult.SUCCESS ? result : next.apply(customer);
            };
        }
    }
    ...
    public static void main(String[] args) {
        ...
        CustomerValidator validator =
                CustomerValidator.isEmailValid()
                        .and(CustomerValidator.isAdult())
                        .and(CustomerValidator.isNameNotEmpty());


        System.out.println(validator.apply(new Customer("Alice", "alice@example.com", 25)));
        ...
        System.out.println(validator.apply(new Customer("", "alice@example.com", 25)));
        System.out.println(validator.apply(new Customer("Peter", "nothing.com", 25)));
        System.out.println(validator.apply(new Customer("Alice", "alice@example.com", 10)));
    }
}
